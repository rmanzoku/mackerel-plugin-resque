...
var graphdef = map[string]mp.Graphs{
	"queue.#": {
		...
		Unit:  "integer",
		Metrics: []mp.Metrics{
			{Name: "count", Label: "Waiting count", Diff: false, Stacked: true},
		},
	},
	"worker": {
		Label: "Resque Worker",
		Unit:  "integer",
		Metrics: []mp.Metrics{
			{Name: "processes", Label: "Worker processes", Diff: false},
		},
	},
	"stat": {
		Label: "Resque stat",
		...
		Metrics: []mp.Metrics{
			...
			{Name: "failed", Label: "Failed processed count", Diff: true},
		},
	},
}
...
func (r ResquePlugin) FetchMetrics() (map[string]interface{}, error) {
	...
	for _, q := range queues {
		...
		ret["queue."+q+".count"] = float64(qlen)
